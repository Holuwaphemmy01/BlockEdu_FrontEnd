...
const images = [
  {
    ...
    subtitle: "Securely store and instantly verify academic achievements with blockchain technology",
  },
  {
    src: cap1,
    title: "Verified Blockchain Records",
    subtitle: "Blockchain technology ensures that your credentials are safe and authentic",
  },
  {
    src: cap3,
    title: "Instant Academic Verification",
    subtitle: "Verify your academic credentials anytime, anywhere with blockchain-powered technology",
  },
];
    ...
    <div className="text-[#464A4C] font-extrabold flex flex-col items-center text-center">
      ...
      <div className="flex-1 p-4 sm:p-6 md:p-8 overflow-y-auto bg-[#e0e0e0] mt-10">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <label htmlFor="message" className="mb-1 text-sm font-semibold text-gray-700 block">
              Message
            </label>
            <textarea
              id="message"
