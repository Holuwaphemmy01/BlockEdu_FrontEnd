...
const Credentials = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("file", file); // Append file as a separate part
    formData.append("data", JSON.stringify(studentData)); // Append JSON data as a separate part
    ...
    try {
      ...
      await axios.post("http://localhost:8000/institution/upload", formData, {
        headers: {
